...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="wrapper">
            ...
            <!--CONTENT-->
            <div class="content">
               <form name="add_bead" method="post" action="lib/add.php" enctype="multipart/form-data">
                    <fieldset class="add">
                        <legend>Добавить украшения на шею</legend>
                        ...
                        <input type="submit" name="btn_addBead" value="Добавить">
                    </fieldset>                    
                </form>
            </div>    
            <!--FOOTER-->
