...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="wrapper">
            ...
            <!--CONTENT-->
            <div class="content">
                <form name="add_earring" method="post" action="lib/add.php" enctype="multipart/form-data">
                    <fieldset class="add">
                        <legend>Добавить серьги</legend>
                        ...
                        <input type="submit" name="btn_addEarring" value="Добавить">
                    </fieldset>                    
                </form>
            </div>    
            <!--FOOTER-->
