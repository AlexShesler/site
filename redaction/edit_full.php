            ...
            <div class="content">
                <div class="form_edit" id="form_edit">                    
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="coating1" value="<?php echo $_POST['coating']; ?>">
                        <label>Вставка: </label>
                        <input type="text" name="insertion1" value="<?php echo $_POST['insertion']; ?>"><br/>
                        <label>Размеры: </label>
                        ...
                        <input type="submit" name="btn_edit_full" value="Изменить">
                    </fieldset>                    
                </form>
                </div>
            </div>    
