<?php
    ...
    if (!empty($_POST['id1']) && !empty($_POST['title1']) && !empty($_POST['article1']) && !empty($_POST['price1']) && !empty($_POST['material1']) && !empty($_POST['sizes1'])){
    ...
    if (isset($_POST['btn_edit_tippet']) && $result == true){
