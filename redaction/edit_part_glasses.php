        ...
        <div class="wrapper">
            ...
            <div class="content">
                <div class="form_edit" id="form_edit">                    
                    <form name="edit_bag" method="post" action="lib/edit.php" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <label>Линза: </label>
                        <input type="text" name="insertion1" value="<?php echo $_POST['insertion']; ?>">
                        ...
                        <input type="hidden" name="coating1" value="<?php echo $_POST['coating']; ?>">
                        <input type="hidden" name="insertion1" value="<?php echo $_POST['insertion']; ?>"><br/>
                        <input type="hidden" name="table1" value="<?php echo $_POST['table']; ?>"><br/>
                        <input type="file" name="file" accept="image/jpeg"><br/>
                        <input type="submit" name="btn_edit_part" value="Изменить">
                    </fieldset>                    
                </form>
                </div>
            </div>    
