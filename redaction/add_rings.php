...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="wrapper">
            ...
            <!--CONTENT-->
            <div class="content">
                <form name="add_ring" method="post" action="lib/add.php" enctype="multipart/form-data">
                    <fieldset class="add">
                        <legend>Добавить кольцо</legend>
                        ...
                        <input type="text" name="sizes" placeholder="размеры">
                        ...
                        <input type="submit" name="btn_addRing" value="Добавить">
                    </fieldset>                    
                </form>
            </div>    
            <!--FOOTER-->
