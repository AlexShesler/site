...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="wrapper">
            ...
            <!--CONTENT-->
            <div class="content">
               <form name="add_woman_watches" method="post" action="lib/add_watches.php" enctype="multipart/form-data">
                    <fieldset class="add">
                        <legend>Добавить женские часы</legend>
                        ...
                        <input type="submit" name="btn_addWomanWatch" value="Добавить">
                    </fieldset>                    
                </form>
            </div>    
            <!--FOOTER-->
