...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="content">
                <div class="form_del">
                    <form name="del_beads" method="post" action="lib/del.php">
                        <fieldset class="add">
                            <legend>Удалить украшения на шею</legend>
                            <input type="text" name="id" placeholder="номер">
                            <input type="submit" name="btn_delBead" value="Удалить">
                        </fieldset>                    
                    </form>
                </div>
