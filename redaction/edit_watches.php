        ...
        <div class="wrapper_redaction">
            ...
            <div class="content">
                <div class="form_edit" id="form_edit">                    
                    <form name="edit_bag" method="post" action="lib/edit_watch.php" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <input type="text" name="mechanism1" value="<?php echo $_POST['mechanism']; ?>">
                            <label>Материал ремешка: </label>
                            <input type="text" name="strap_material1" value="<?php echo $_POST['strap_material']; ?>">
                            <label>Материал корпуса: </label>
                            <input type="text" name="body_material1" value="<?php echo $_POST['body_material']; ?>"><br/>
                            <label>Комментарий: </label>
                            <input type="text" name="description1" value="<?php echo $_POST['description']; ?>">
                            ...
                            <input type="submit" name="btn_edit_watches" value="Изменить">
                        </fieldset>                    
                    </form>
                </div>
            </div>    
