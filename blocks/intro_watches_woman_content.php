<div class="content_tbl">    
    <div class="preview">
        <a href="../woman_watchs_product.php?id=<?php echo $id;?>">
            <?php
            ...
            ?>
            <img src="../images/content/woman_watchs/woman_watch_<?php echo $id;?>.jpg" alt="<?php echo $title;?>" width="200" height="200">
