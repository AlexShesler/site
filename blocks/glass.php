<div class="full_product clearfix">
    ...
    <div class="left img">
        ...
        <img src="../images/content/glasses/glasse_<?php echo $id;?>.jpg" alt="<?php echo $title;?>" width="300" height="300">
    ...
    <div class="left materials">
        ...
        <b>Оправа:</b> <?php echo $material;?><br/>
        <b>Линза:</b> <?php echo $insertion;?><br/>
    </div>
