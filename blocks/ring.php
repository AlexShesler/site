<div class="full_product clearfix">
    ...
    <div class="left img">
        ...
        <img src="../images/content/rings/ring_<?php echo $id;?>.jpg" alt="<?php echo $title;?>" width="300" height="300">
    ...
    <div class="left materials">
        ...
        <b>Металл:</b> <?php echo $material;?><br/>
        <b>Покрытие:</b> <?php echo $coating;?><br/>
        <b>Вставка:</b> <?php echo $insertion;?><br/>
        <b>Размеры в наличии: </b> <?php echo $sizes;?><br/>
    </div>
    ...
    <div class="left form">
        ...
        ?>
        <button class="fast" onclick="fastForm_open()">Быстрый заказ</button>
    </div>
