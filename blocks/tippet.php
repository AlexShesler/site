<div class="full_product clearfix">
    ...
    <div class="left img">
        ...
        <img src="../images/content/tippets/tippet_<?php echo $id;?>.jpg" alt="<?php echo $title;?>" width="300" height="300">
    ...
    <div class="left materials">
        ...
        <b>Состав:</b> <?php echo $material;?><br/>
        <b>Размер:</b> <?php echo $sizes;?><br/>
    </div>
